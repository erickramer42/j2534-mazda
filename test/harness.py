...
Rig layout (defaults to this script's directory; override with J2534_TEST_DIR):
    test/OBDXVX_J2534.dll        <- proxy build (copied by CMake)
    test/OBDXVX_J2534_real.dll   <- mock build, renamed (copied by CMake)
...
PROXY_DLL  = os.path.join(TEST_DIR, "OBDXVX_J2534.dll")
REAL_DLL   = os.path.join(TEST_DIR, "OBDXVX_J2534_real.dll")
